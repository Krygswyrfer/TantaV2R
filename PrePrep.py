...
trivt_list = {
    ...
    "ans1": "G19", "ans2": ".357 Magnum", "ans3": "M45A1", "ans4": "P92X", "answer": "3"},
    ...
    69: {"question": "In *Hell Let Loose*, what weapon does the German \"Sänitater\" Medic class use?", 
    ...
    92: {"question": "In *Hell Let Loose*, how many supplies are required to construct a level 1 Bunker?", 
    ...
    101: {"question": "Name the error that plagued *PlanetSide 2* for a month after the Arsenal Update.", 
    "ans1": "G2 Error", "ans2": "G15 Error", "ans3": "G21 Error", "ans4": "G99 Error", "answer": "2"},
    102: {"question": "Which *PlanetSide 2* server experienced issues with its API after the Arsenal Update?", 
    "ans1": "Connery", "ans2": "SolTech", "ans3": "Emerald", "ans4": "Miller", "answer": "2"},
    103: {"question": "Which *PlanetSide 2* faction received the biggest changes to its directive weapons in the Arsenal Update?", 
    "ans1": "New Conglomerate", "ans2": "Terran Republic", "ans3": "Vanu Sovereignty", "ans4": "Nanite System Operatives", "answer": "3"},
    ...
    107: {"question": "There is only one semi-automatic shotgun in *Tom Clancy's Rainbow Six Vegas* and *Tom Clancy's Rainbow Six Vegas 2*. \
